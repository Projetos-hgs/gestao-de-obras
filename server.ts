...
if (!process.env.DATABASE_URL) {
  console.error('[server] DATABASE_URL não está definida.');
  process.exit(1);
}
...
app.put('/api/projects/:id', async (req, res) => {
  try {
    ...
    const [project] = await sql`
      UPDATE projects SET
        name = ${name}, justification = ${justification}, budget = ${budget},
...
// TAP sub-recursos
app.put('/api/projects/:id/tap', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/schedule/:itemId', async (req, res) => {
  try {
...
app.delete('/api/schedule/:itemId', async (req, res) => {
  try {
    const { itemId } = req.params;
...
// RDO
// ============================================================
app.get('/api/projects/:id/rdos', async (req, res) => {
  try {
    const { id } = req.params;
...
app.post('/api/projects/:id/rdos', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/rdos/:rdoId', async (req, res) => {
  try {
...
app.delete('/api/rdos/:rdoId', async (req, res) => {
  try {
    const { rdoId } = req.params;
...
app.put('/api/team/:memberId', async (req, res) => {
  try {
...
app.post('/api/projects/:id/materials', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/materials/:materialId', async (req, res) => {
  try {
    ...
    const { name, required, received, unit, vendor, status } = req.body;
    const [row] = await sql`
      UPDATE materials SET name=${name}, required=${required}, received=${received}, unit=${unit}, vendor=${vendor}, status=${status}, updated_at=NOW()
...
app.post('/api/projects/:id/financial', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/financial/:entryId', async (req, res) => {
  try {
...
app.delete('/api/financial/:entryId', async (req, res) => {
  try {
    const { entryId } = req.params;
...
app.put('/api/companies/:companyId', async (req, res) => {
  try {
    ...
    const { name, cnpj, contact, email, phone, type } = req.body;
    const [row] = await sql`
      UPDATE companies SET name=${name}, cnpj=${cnpj}, contact=${contact}, email=${email}, phone=${phone}, type=${type}, updated_at=NOW()
...
// DOCUMENTAÇÃO LEGAL
// ============================================================
app.get('/api/projects/:id/legal-docs', async (req, res) => {
  try {
    const { id } = req.params;
...
app.post('/api/projects/:id/legal-docs', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/legal-docs/:docId', async (req, res) => {
  try {
...
app.delete('/api/legal-docs/:docId', async (req, res) => {
  try {
    const { docId } = req.params;
...
// Projetos Técnicos
app.get('/api/projects/:id/technical-projects', async (req, res) => {
  try {
    const { id } = req.params;
...
app.post('/api/projects/:id/technical-projects', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/technical-projects/:tpId', async (req, res) => {
  try {
...
app.delete('/api/technical-projects/:tpId', async (req, res) => {
  try {
    const { tpId } = req.params;
...
app.put('/api/risks/:riskId', async (req, res) => {
  try {
...
app.delete('/api/risks/:riskId', async (req, res) => {
  try {
    const { riskId } = req.params;
...
// ============================================================
app.get('/api/projects/:id/non-conformities', async (req, res) => {
  try {
    const { id } = req.params;
...
app.post('/api/projects/:id/non-conformities', async (req, res) => {
  try {
    const { id } = req.params;
...
app.put('/api/non-conformities/:ncId', async (req, res) => {
  try {
...
app.delete('/api/non-conformities/:ncId', async (req, res) => {
  try {
    const { ncId } = req.params;
